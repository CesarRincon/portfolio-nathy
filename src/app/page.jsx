...
export default function Home() {
  ...
  return (
    <main className="min-h-screen w-full font-sans">
      {/* HEADER sticky */}
      <header
        className={`block lg:fixed top-0 left-0 w-full z-50 transition-colors duration-300 bg-white shadow-md  ${
          isScrolled
      ...
      >
        ...
        <div className="fixed bg-black z-50 w-full">
          <div
            className={`fixed top-0 left-0 h-full w-full bg-black shadow flex items-center justify-center opacity-98 transform transition-transform duration-300 ease-in-out
      ...
      <div>
        ...
        {/* ABOUT */}
        <section
          className="flex flex-col md:flex-row items-center justify-center px-2  mx-auto max-w-7xl"
        ...
        >
          ...
          >
            <img
              src={"/images/nathy1.jpg"}
              alt="Profile"
              style={{
                boxShadow: isDesktop ? "0 0 40px rgba(0, 0, 0, .2)" : "",
              }}
              className="h-[90%] w-[90%] xl:h-[90%] xl:w-[50%] lg:h-[90%] lg:w-[60%] object-cover"
            />
          </div>

          {/* Texto */}
          <div className="flex-col max-w-xl justify-center items-center px-8 py-4">
            <span className="inline-block bg-gray-200 text-gray-700 px-3 py-1 mb-4 uppercase text-sm font-semibold">
              Sobre mi
            </span>
            <h2 className="text-2xl md:text-4xl sm:text-2xl font-bold mb-6 text-black text-center">
              Creadora de contenido &amp; Comunicadora social
            </h2>
            <p className="text-gray-600 mb-6 text-justify">
              Comunicadora social en formación, actualmente en sexto semestre,
              con enfoque en comunicación digital y gestión de redes sociales.
              Me he desempeñado como community manager, creando contenido
              estratégico, visualmente atractivo y orientado a resultados.
              Manejo herramientas como Adobe Photoshop, Premiere Pro, Audition,
              After Effects, CapCut y Canva para diseño gráfico, edición de
              video y audio. Además, cuento con experiencia en la gestión y
              análisis de redes sociales mediante Meta Business Suite y
              Metricool. Me destaco por mi creatividad, pensamiento visual,
              redacción persuasiva y capacidad para conectar marcas con su
              audiencia de forma auténtica y efectiva.
            </p>
            <a
              href="#"
        ...
        <section
          id="services"
          className="py-8 px-8 bg-[#F9F9F9] flex items-center justify-center"
        >
          <div className="max-w-5xl">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {[
                ...
                <div
                  key={i}
                  className="border p-6 hover:bg-gray-50 transition rounded-lg"
                ...
                >
                  ...
                  <h3 className="text-2xl font-semibold mb-4 text-black text-center mt-3 h-15">
                    {s.title}
                  </h3>
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {[1, 2, 3, 4, 5, 6].map((i) => (
                <div
                  key={i}
                  className="border border-gray-300 overflow-hidden hover:shadow-lg transition"
                >
                  <img
                    src={`/project${i}.jpg`}
                    alt={`Project ${i}`}
        ...
        <section id="contact" className="py-32 px-8 border-t border-gray-200">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-gray-600 mb-8">
              I’m currently taking on freelance projects. If you’d like to work
              together, feel free to drop me a message.
            </p>
